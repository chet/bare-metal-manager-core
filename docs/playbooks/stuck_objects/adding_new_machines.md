...
3. Update the BMC credentials for an existing expected machine:
   ...
   Supply both `--bmc-username` and `--bmc-password`, even when only the password changes.
   The patch preserves other fields. For additional options, refer to the
