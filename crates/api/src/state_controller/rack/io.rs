...
use db::rack::{IdColumn, RackControllerStateWriter, RackOutcomeWriter};
use db::rack_state_history::RackStateHistoryWriter;
...
impl StateControllerIO for RackStateControllerIO {
    ...
    type StateHistory = RackStateHistoryWriter;
    type ControllerStateWriter = RackControllerStateWriter;
    type OutcomeWriter = RackOutcomeWriter;
