...
pub async fn create(
    ...
    sqlx::query_as(query)
        ...
        .bind(&power_shelf.data.bmc_username)
        .bind(&power_shelf.data.bmc_password)
        .bind(&power_shelf.data.serial_number)
        .bind(power_shelf.data.ip_address)
        .bind(&power_shelf.data.metadata.name)
        .bind(&power_shelf.data.metadata.description)
        .bind(sqlx::types::Json(&power_shelf.data.metadata.labels))
        .bind(&power_shelf.data.rack_id)
        .fetch_one(txn)
        .await
